<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="register.aspx.vb" Inherits="bakery.register1" %>
                ...
                <tr>
                    <td class="style1">
                        <div class="login-area position-relative">
                            ...
                            <div class="login position-absolute top-50 start-50 translate-middle z-5">
                                <h1>Register</h1>
                                    <asp:TextBox ID="txtname" runat="server" class="form-control mt-2 mb-3" placeholder="Enter Your Full Name"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                    ErrorMessage="Please Enter Your Username" SetFocusOnError="True" 
                                    ControlToValidate="txtname" Font-Bold="True" Font-Names="FangSong" 
                                    Font-Size="24px" ForeColor="Red" style="margin-left: 25%;"></asp:RequiredFieldValidator>
                                    

                                    <asp:TextBox ID="txtemail" runat="server" class="form-control mt-2 mb-3" placeholder="Enter Your Email"></asp:TextBox>
                                    ...
                                    <asp:TextBox ID="txtpwd" runat="server" class="form-control mt-2 mb-3" 
                                    ...
                                    <asp:TextBox ID="txtcpwd" runat="server" class="form-control mt-2 mb-3" 
                                    ...
                                    SetFocusOnError="True"  style="margin-left: 25%;" Font-Bold="True" 
                                    Font-Names="FangSong" Font-Size="24px" ForeColor="Red"></asp:CompareValidator>

                                    <asp:Button ID="Button1" runat="server" class="submit mt-5" Text="Submit" />
                                </div>
                        </div>    
                    </td>
                </tr>
